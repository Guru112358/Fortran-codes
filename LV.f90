    program lotka_volterra
            ...
            open(3,file="xplot3.plt",status='replace')
            open(4,file="yplot3.plt",status='replace')
            open(5,file="xvsy3.dat",status='replace')
            open(6,file="xyphaseplot3.plt",status='replace')
            open(8,file='zplot3.plt',status='replace')
        ...
        write(3,*)'plot "xpopulation3.dat" with line'
        CALL SYSTEM('gnuplot -p xplot3.plt')
        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
